...
public abstract class ALayout extends Application implements WindowSize,
    ...
    public final Insets SEPARATE_ELEMENT_LEFT = new Insets(0, 0,
            SEPARATE_DISTANCE, MARGIN_BORDER);
    public final Insets SEPARATE_ELEMENT_CENTER = new Insets(0, 0,
            SEPARATE_DISTANCE, 0);
    public final Insets SEPARATE_ELEMENT_RIGHT = new Insets(0, MARGIN_BORDER,
            SEPARATE_DISTANCE, 0);
    ...
    protected final void ALIGN_BOTTOM_LEFT(Node... child) {
        for (Node n : child) {
            ...
            StackPane.setMargin(n,
                    new Insets(0, 0, MARGIN_BORDER / 2, MARGIN_BORDER));
        }
    ...
    protected final void ALIGN_BOTTOM_RIGHT(Node... child) {
        for (Node n : child) {
            ...
            StackPane.setMargin(n,
                    new Insets(0, MARGIN_BORDER, MARGIN_BORDER / 2, 0));
        }
    ...
    protected final void ALIGN_TOP_LEFT(Node... child) {
        for (Node n : child) {
            ...
            StackPane.setMargin(n,
                    new Insets(MARGIN_BORDER / 2, 0, 0, MARGIN_BORDER));
        }
    ...
    protected final void ALIGN_TOP_RIGHT(Node... child) {
        for (Node n : child) {
            ...
            StackPane.setMargin(n,
                    new Insets(MARGIN_BORDER / 2, MARGIN_BORDER, 0, 0));
        }
    }
